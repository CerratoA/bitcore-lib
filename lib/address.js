...
function Address(data, network, type) {
  ...
  if (type && (type !== Address.PayToPublicKeyHash && type !== Address.PayToScriptHash)
    && (type !== Address.PayToPublicKeyHash256 && type !== Address.PayToScriptHash256)) {
...
/** @static */
Address.PayToPublicKeyHash256 = 'pubkeyhash256';
/** @static */
Address.PayToScriptHash256 = 'scripthash256';
...
Address._classifyFromVersion = function(buffer) {
  ...
  {
    var pubkeyhash256Network = Networks.get(buffer[0], 'pubkeyhash256');
    var scripthash256Network = Networks.get(buffer[0], 'scripthash256');
    if (pubkeyhash256Network) {
      version.network = pubkeyhash256Network;
      version.type = Address.PayToPublicKeyHash256;
    } else if (scripthash256Network) {
      version.network = scripthash256Network;
      version.type = Address.PayToScriptHash256;
    }
  }
